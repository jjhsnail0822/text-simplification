...
def main():
    ...
    training_args = GRPOConfig(
        output_dir="results/grpo/Qwen3-4B-Instruct-2507-GRPO-coherence-another",
        use_vllm=True,
        vllm_mode="colocate",
        ...
        logging_steps=5,
        save_steps=200,
        # weights for [vocab_level, unique_words, bertscore, entailment, length_ratio, distinct_n, language_purity, text_coherence]
        # reward_weights=[4.0, 1.0, 1.0, 2.0, 0.5, 1.0, 0.5],
        reward_weights=[4.0, 1.5, 0.5, 1.5, 0.5, 1.0, 0.5, 1.0],
